...
def est_shear(m, g1, g2):
    ...
    col = ["KSB_g1", "BJ_e1", "RG_e1", "FQ_G1", "fg1", "KSB_g2", "BJ_e2", "RG_e2", "FQ_G2", "fg2", "FG_N", "FQ_U", "FQ_V", "SNR_ORI"]
    for k in range(chip_num):
        ...
        for j in range(len(gal_pool)):
            ...
            gal = gal_pool[j]
            noise = numpy.random.normal(loc=0., scale=380.8645, size=stamp_size**2).reshape(stamp_size, stamp_size)
            ...
            data_matrix[j, :] = ksb_g1, bj_e1, re_e1, G1, g1, ksb_g2, bj_e2, re_e2, G2, g2, N, U, V, cat_data[j]
