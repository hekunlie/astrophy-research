...
if int(argv[1]) == 1:
    comm = ['mpirun -np 140 python2 selection_bias_images_h.py','mpiexec -n 140 /home/hkli/work/c/measure',
            'mpirun -np 14 python selection_bias_proce_dat_h.py flux 0 1000000 0 sym 10']
else:
    comm = ['mpirun -np 14 python sym_mc_plot_h.py peak', 'mpirun -np 14 python sym_mc_plot_h.py flux',
            'mpirun -np 14 python sym_mc_plot_h.py fsnr', 'mpirun -np 14 python sym_mc_plot_h.py fsnr4',
