...
if int(argv[1]) == 1:
    ...
    comm = ['mpirun -np 14 python sym_mc_plot_h.py peak', 'mpirun -np 14 python sym_mc_plot_h.py flux',
            'mpirun -np 14 python sym_mc_plot_h.py fsnr_f','mpirun -np 14 python sym_mc_plot_h.py fsnr_c',
            'mpirun -np 14 python sym_mc_plot_h.py sesnr', 'mpirun -np 14 python sym_mc_plot_h.py osnr',
