...
if os.path.exists(data_path + "/tomo_pk.npz"):
    ...
    xi_p_theoretical_lines = npz["arr_6"]
    xi_m_theoretical_lines = npz["arr_7"]
    xi_theta = npz["arr_5"]
        ...
        for j in range(zbin_num):
            ...
            if j >= i:
                ...
                if ii == 0 and pk_lines_tag == 1:
                    ...
                    img.axs[img_row][img_col].plot(xi_theta, xi_p_theoretical_lines[tag], c="k",ls="dashdot", label=pk_line_label)
    ...
    for i in range(zbin_num):
        for j in range(zbin_num):
            ...
            if j >= i:
                ...
                if ii == 0 and pk_lines_tag == 1:
                    pk_line_label = "Planck2018:\n$\Omega_m=0.313$\n$\sigma_8=0.8097$"
                    img.axs[img_row][img_col].plot(xi_theta, xi_m_theoretical_lines[tag], c="k",ls="dashdot", label=pk_line_label)
