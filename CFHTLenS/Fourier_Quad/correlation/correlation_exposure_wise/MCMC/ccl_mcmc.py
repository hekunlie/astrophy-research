...
def log_prob_ccl(paras, theta_deg, xi, cov_inv, theta_num_per_bin, zpts, zhist, ell, used_zbin):
    ...
    if not numpy.isfinite(lp):
        ...
        # print(paras)
        try:
            xi_predict = cf_tool.get_tomo_xi_ccl_2(sigma8, omega_cm0, omega_bm0, h, zpts, zhist,
                                                   theta_deg, theta_num_per_bin, ell, used_zbin)
