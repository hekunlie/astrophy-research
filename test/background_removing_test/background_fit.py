...
val_scale = 100000
src_img = fits.open("D:/noname/ll800+fg.fits")[0].data*val_scale
# nx,ny = 1000,1000
ny, nx = src_img.shape
pix_num = nx*ny
...
hdu.writeto("D:/noname/background.fits",overwrite=True)

hdu = fits.PrimaryHDU(src_img/val_scale - fxy_fit/val_scale)
hdu.writeto("D:/noname/source.fits",overwrite=True)