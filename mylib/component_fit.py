...
def get_bingrid(data_1, data_2, bin_num, mode=0, percen_low=0.5, percen_up=99.5):
    ...
    return num, xgrid, ygrid, numpy.sqrt(xgrid ** 2 + ygrid ** 2), d1_bins, d2_bins
...
def get_dipole(num, radius, radius_bin_num):
    ...
    for i in range(radius_bin_num):
        ...
        raidus_mask[idx] = i
    return num_dipole, radius_bin, raidus_mask, mean_num
...
def fit_quadrupole(quadrupole, xgrid, ygrid, radius_bin, radius_bin_num):
    ...
    return num_quadrupole_fit, sin_2theta, cos_2theta
