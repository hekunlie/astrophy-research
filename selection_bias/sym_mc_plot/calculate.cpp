...
{   
    ...
    int data_col, data_row, sub_data_row;
    int result_col;
    double *data, *mg1, *mg2,*mn,*mnu1, *mnu2;
    double *mg1_w, *mg2_w, *mn_w;
    double weight;
    ...
    mg1 = new double[sub_data_row];
    mg2 = new double[sub_data_row];
    mn = new double[sub_data_row];
    mnu1 = new double[sub_data_row];
    mnu2 = new double[sub_data_row];

    mg1_w = new double[sub_data_row];
    mg2_w = new double[sub_data_row];
    mn_w = new double[sub_data_row];
    ...
    {   
        ...
        // read data
        for(k=0;k<sub_data_row;k++)
        {
	        weight = 1./data[k*data_col]/data[k*data_col];
            mg1_w[k] = data[k*data_col + 2]*weight;
            mg2_w[k] = data[k*data_col + 3]*weight;
            mn_w[k] = data[k*data_col + 4]*weight;
        ...
        // MEAN
        find_shear_mean(mg1_w, mn_w, sub_data_row, gh1, gh1_sig, 1000,100);
        find_shear_mean(mg2_w, mn_w, sub_data_row, gh2, gh2_sig, 1000,100);
        ...
        try
        {
            find_shear(mg1, mnu1, sub_data_row, mg_bin_num, gh1, gh1_sig, chi_check, chi_check_num);
        ...
        try
        {
            find_shear(mg2, mnu2, sub_data_row, mg_bin_num, gh2, gh2_sig, chi_check, chi_check_num);
    ...
    {   
        ...
        write_h5(result_path,set_name, mean_mc, 1, 4, false);
        sprintf(set_name,"/mc2");
        write_h5(result_path,set_name, &mean_mc[4], 1, 4, false);
