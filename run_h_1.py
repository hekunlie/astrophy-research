...
for i in ["fsnr", "snr"]:
    cmd = 'mpirun -np 25 python sym_mc_plot_cfht.py %s' % i
...
# for j in range(4):
#     for i in range(8):
#         cmd = 'mpirun -np 14 python selection_bias_proce_dat_h.py sex %.2f 1000000  sym 5 %d'%(sex_cut[j], i)
#         a = Popen(cmd, shell=True)
#         a.wait()
#
# snr_cut = [16., 25., 40., 70.]
# for j in range(4):
#     for i in range(8):
#         cmd = 'mpirun -np 14 python selection_bias_proce_dat_h.py snr %.2f 1000000  sym 5 %d'%(snr_cut[j], i)
#         a = Popen(cmd, shell=True)
#         a.wait()
# fsnr_cut = [3.5, 6., 10., 15.]
# for j in range(4):
#     for i in range(8):
#         cmd = 'mpirun -np 14 python selection_bias_proce_dat_h.py fsnr %.2f 1000000 sym 5 %d'%(fsnr_cut[j], i)
#         a = Popen(cmd, shell=True)
#         a.wait()