...
if rank == 0:
    ...
    img.axs[0][0].errorbar(x, final_signal[:, 0]*100,final_signal[:, 1]*100, capsize=5, c="C1", label="T",linestyle="--")
    img.axs[0][0].errorbar(x, final_signal[:, 2]*100,final_signal[:, 3]*100, capsize=5, c="C2", label="X",linestyle="--")

    img.axs[0][1].errorbar(x, final_signal[:, 4],final_signal[:, 5], capsize=5, c="C1",  label="T",linestyle="--")
    img.axs[0][1].errorbar(x, final_signal[:, 6],final_signal[:, 7], capsize=5, c="C2",  label="X",linestyle="--")
    img.axs[0][0].legend()
    img.axs[0][1].legend()
