...
int main(int argc, char *argv[])
{
	...
	int zmin_lb = 15, zmax_lb = 16, odds_lb = 17, dist_integ_id=18;
	...
	sprintf(h5f_path_src, "%sfourier_cata_old/fourier_cata_cut.hdf5", data_path);
	sprintf(h5f_path_dst, "%sfourier_cata_old/fourier_cata_grid.hdf5", data_path);
